...
class MovieDetailScreen extends StatelessWidget{
  ...
  const MovieDetailScreen({required Key key, required this.movie}) : super(key: key);
  ...
  Widget _buildDetailBody(BuildContext context){
    return BlockBuilder<MovieDetailBloc, MovieDetailState>(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                            ...
                            Column(
                              ...
                              children: <Widget>[
                                Text(
                                  ...
                                  style: Theme.of(context).textTheme.caption.copyWith(fontWeight: FontWeight.bold, fontFamily: 'muli'),
                                ),
                                Text(
                                  movieDetail.releaseDate,
                                  style: Theme.of(context).textTheme.subtitle2.copyWith(color: Colors.yellow[800], fontSize: 12, fontFamily: 'muli'),
                                ),
                              ],
                            ),
                            Column(
                        ...
                        Container(
                          ...
                          child: ListView.separated(
                            scrollDirection: Axis.horizontal,
                            separatorBuilder: (context, index) => VerticalDivider(color: Colors.transparent, width: 5,),
